...
public class MapperClassPathScanHandler extends ClassPathBeanDefinitionScanner {

    public MapperClassPathScanHandler(BeanDefinitionRegistry registry, boolean useDefaultFilters) {
